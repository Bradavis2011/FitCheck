...
export const FEW_SHOT_EXAMPLES: FewShotExample[] = [
  // EXAMPLE 1: Date Night - High Score
  {
    ...
    exemplaryFeedback: {
      ...
      whatsWorking: [
        'The wrap cut creates strong waist definition — the silhouette earns its place at this formality level',
        'Burgundy is the correct color call for an upscale evening setting — rich without announcing itself',
        'Midi length is the right decision for this venue — not trying too hard, not underdressed',
      ],
      consider: [
  ...
  // EXAMPLE 2: Job Interview - Medium Score
  {
    ...
    exemplaryFeedback: {
      ...
      summary: 'The blazer earns its place. What\'s under it is pulling the formality down.',
      whatsWorking: [
  ...
  // EXAMPLE 3: Casual Weekend - High Score
  {
    ...
    exemplaryFeedback: {
      ...
      summary: 'Clean color story. The proportion is working — one decision to finalize.',
      whatsWorking: [
        'The high-waist placement and partial tuck create a strong vertical line — proportionally correct',
        'Light, neutral palette reads appropriate for an outdoor midday setting without effort',
        'The straw tote is the right call — practical and seasonally coherent',
      ],
      consider: [],
      quickFixes: [
  ...
  // EXAMPLE 4: Business Meeting - Lower Score with Constructive Redirect
  {
    ...
    exemplaryFeedback: {
      ...
      summary: 'The individual pieces have merit. The combination isn\'t meeting the brief.',
      whatsWorking: [
  ...
  // EXAMPLE 5: Summer Wedding Guest - High Score
  {
    ...
    exemplaryFeedback: {
      ...
      summary: 'This reads correctly for a garden wedding — occasion-appropriate without overclaiming.',
      whatsWorking: [
        'Floral midi is the right formality for a garden reception — celebratory without competing with the occasion',
        'Midi length is the right call here — elevated without overdressing',
        'Block heel is a smart decision for an outdoor venue — comfort and polish aren\'t in conflict',
        'Blue and pink florals are celebratory without competing with the bride — the color read is considered',
      ],
      consider: [],
      quickFixes: [
  ...
  // EXAMPLE 6: First Day at Work - Medium Score
  {
    ...
    exemplaryFeedback: {
      ...
      summary: 'Smart-casual brief met. Clean palette, appropriate formality for a first day.',
      whatsWorking: [
  ...
  // EXAMPLE 8: Evening Cocktail Event - High Score
  {
    ...
    exemplaryFeedback: {
      ...
      summary: 'The jumpsuit is doing the work — decisive silhouette for the occasion.',
      whatsWorking: [
        'Black wide-leg jumpsuit is a strong call for a cocktail setting — the silhouette is intentional',
        'Wide-leg cut creates a clean, elongated line — proportionally strong',
        'Statement earrings are the right accent — singular, not competing with the outfit',
        'Red lip is a considered choice — the outfit can carry it, and it completes the look',
      ],
      consider: [],
      quickFixes: [
